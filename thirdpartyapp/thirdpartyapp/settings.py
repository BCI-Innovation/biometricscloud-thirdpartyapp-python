"""
Django settings for thirdpartyapp project.
...
ROOT_URLCONF = 'thirdpartyapp.urls'
...
WSGI_APPLICATION = 'thirdpartyapp.wsgi.application'
...
CLIENT_AUTHORIZE_URL = env('CLIENT_AUTHORIZE_URL')
CLIENT_BASE_URL = env('CLIENT_BASE_URL')
CLIENT_TOKEN_URL = env('CLIENT_TOKEN_URL')
